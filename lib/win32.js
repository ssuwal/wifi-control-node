...
(function() {
  ...
  win32WirelessProfileBuilder = function(ssid, security, key, hidden) {
    var profile_content;
    if (security == null) {
      security = false;
    }
    ...
    profile_content = "<?xml version=\"1.0\"?> <WLANProfile xmlns=\"http://www.microsoft.com/networking/WLAN/profile/v1\"> <name>" + ssid.plaintext + "</name> <SSIDConfig> <SSID> <hex>" + ssid.hex + "</hex> <name>" + ssid.plaintext + "</name> </SSID>";
    if (hidden) {
  ...
  module.exports = {
    ...
    connectToAP: function(_ap) {
      ...
      xmlContent = null;
      if (_ap.hidden && _ap.password.length) {
